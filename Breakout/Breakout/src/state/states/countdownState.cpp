...
{
  DrawTextEx(defaultFont, "CountdownState", {20, 30}, 28.0f, 1.0f, BLACK);
  Vector2 textSize = MeasureTextEx(defaultFont, &countString, 28.0f, 1.0f);
  DrawTextEx(defaultFont, &countString, {(float)WINDOW_WIDTH / 2 - textSize.x / 2, (float)WINDOW_HEIGHT / 2 - textSize.y / 2}, 28.0f, 1.0f, BLACK);
}
